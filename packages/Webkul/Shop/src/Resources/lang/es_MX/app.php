...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'locale'                 => 'Idioma',
                'newsletter-text'        => '¡Prepárate para nuestro divertido boletín informativo!',
    ...
    'search' => [
        ...
        'images' => [
            'index' => [
                ...
                'something-went-wrong' => 'Algo salió mal, por favor inténtalo de nuevo más tarde.',
            ],
    ...
    'compare' => [
        'already-added'      => 'El artículo ya se ha añadido a la lista de comparación',
        'delete-all'         => 'Eliminar todo',
        'empty-text'         => 'No tienes ningún artículo en tu lista de comparación',
        'item-add-success'   => 'Artículo añadido con éxito a la lista de comparación',
        'product-compare'    => 'Comparación de productos',
        'remove-all-success' => 'Todos los artículos se han eliminado con éxito.',
        'remove-error'       => 'Algo salió mal. Por favor, inténtalo de nuevo más tarde.',
        'remove-success'     => 'Artículo eliminado con éxito.',
    ...
    'checkout' => [
        'success' => [
            ...
            'thanks'        => '¡Muchas gracias por su pedido!',
    ...
    'errors' => [
        ...
        '404' => [
            'description' => '¡Vaya! La página que estás buscando parece que se ha ido de vacaciones. Parece que no pudimos encontrar lo que estabas buscando.',
            'title'       => '404 Página no encontrada',
        ],

        '401' => [
            'description' => '¡Vaya! Parece que no tienes permiso para acceder a esta página. Parece que te faltan las credenciales necesarias.',
            'title'       => '401 No autorizado',
        ],

        '403' => [
            'description' => '¡Vaya! Esta página está prohibida. Parece que no tienes los permisos necesarios para ver este contenido.',
            'title'       => '403 Prohibido',
        ],

        '500' => [
            'description' => '¡Vaya! Algo salió mal. Parece que estamos teniendo problemas para cargar la página que estás buscando.',
            'title'       => '500 Error Interno del Servidor',
        ],

        '503' => [
            'description' => '¡Vaya! Parece que estamos temporalmente fuera de línea debido a trabajos de mantenimiento. Por favor, vuelve más tarde.',
    ...
    'subscription' => [
        ...
        'subscribe-success'   => 'Te has suscrito exitosamente a nuestro boletín.',
        'unsubscribe-success' => 'Te has dado de baja exitosamente de nuestro boletín.',
    ],

    'emails' => [
        'dear'   => 'Estimado/a :customer_name',
        'thanks' => 'Si necesita ayuda, por favor contáctenos en <a href=":link" style=":style">:email</a>.<br/>¡Muchas gracias!',

        'customers' => [
            'registration' => [
                'credentials-description' => 'Su cuenta ha sido creada. Los detalles de su cuenta se encuentran a continuación:',
                'description'             => 'Su cuenta ha sido creada exitosamente y puede iniciar sesión con su dirección de correo electrónico y contraseña. Después de iniciar sesión, puede acceder a otros servicios, incluyendo la revisión de pedidos anteriores, listas de deseos y la edición de la información de su cuenta.',
                'greeting'                => '¡Bienvenido y muchas gracias por registrarse con nosotros!',
                'password'                => 'Contraseña',
                'sign-in'                 => 'Iniciar sesión',
            ...
            'forgot-password' => [
                'description'    => 'Recibes este correo electrónico porque hemos recibido una solicitud de restablecimiento de contraseña para tu cuenta.',
            ...
            'update-password' => [
                'description' => 'Recibes este correo electrónico porque has actualizado tu contraseña.',
                'greeting'    => '¡Contraseña actualizada!',
                'subject'     => 'Contraseña actualizada',
            ],

            'verification' => [
                'description'  => 'Por favor, haz clic en el botón de abajo para verificar tu dirección de correo electrónico.',
                'greeting'     => '¡Bienvenido!',
                'subject'      => 'Correo electrónico para la verificación de la cuenta',
                'verify-email' => 'Verificar dirección de correo electrónico',
            ],

            'commented' => [
                'description' => 'La nota es - :note',
        ...
        'orders' => [
            'created' => [
                'greeting' => 'Muchas gracias por su pedido :order_id, realizado el :created_at',
            ...
            'refunded' => [
                'greeting' => 'El reembolso ha sido iniciado para el pedido :order_id, realizado el :created_at',
            ...
            'canceled' => [
                'greeting' => 'Tu pedido :order_id, realizado el :created_at, ha sido cancelado',
            ...
            'commented' => [
                'subject' => 'Nuevo comentario añadido',
                'title'   => 'Nuevo comentario añadido a tu pedido :order_id, realizado el :created_at',
            ],
